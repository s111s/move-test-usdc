module movement::TestUSDC{
    ...
    const ASSET_SYMBOL: vector<u8> = b"USDC-Test";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            constructor_ref,
            option::none(),
            utf8(b"Test USDC for HabitHub Team by s111s"), /* name */
            utf8(ASSET_SYMBOL), /* symbol */
            8, /* decimals */
            utf8(b"https://drive.google.com/file/d/1CueRtfJVpNCpwvS4tGAmfUbn7z1sZgwt/view?usp=sharing"), /* icon */
            utf8(b"https://github.com/s111s"), /* project */
        );
    ...
    public fun get_metadata(): Object<Metadata> {
        let asset_address = object::create_object_address(&@movement, ASSET_SYMBOL);
